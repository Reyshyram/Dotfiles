...
yay -S --needed --noconfirm bibata-cursor-theme ttf-meslo-nerd-font-powerlevel10k visual-studio-code-bin floorp-bin g4music swaync hardcode-fixer-git papirus-folders-catppuccin-git catppuccin-gtk-theme-mocha rofi-lbonn-wayland nwg-drawer-bin wlogout xwaylandvideobridge github-desktop-bin hyprlock swww hypridle hyprpicker grimblast-git aurutils arch-update nwg-displays wlr-randr
